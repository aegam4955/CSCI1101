...
plt.scatter(df_main["first_release_date"], df_main["critic_rating_value"], color = "red", label = "Critic Ratings")

plt.scatter(df_main["first_release_date"], df_main["user_rating_value"], color = "orange", label = "User Ratings")
